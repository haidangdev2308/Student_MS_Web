...
// láy secret key để decoder jwt, chịu trách nhiệm verify token
@Component
public class CustomJwtDecoder implements JwtDecoder {
    ...
    public Jwt decode(String token) throws JwtException {
        ...
        try {
            var response = authenticationService.introspect(IntrospectRequest.builder()//kim tra token còn hiệu lực khng
                    .token(token)
                    .build());
